...
export default function FloatingButtons() {
  ...
  const waMessage = encodeURIComponent("Hi! I'd like to book a table at The Tarrace.")
  ...
  return (
    <div style={{
      ...
      <AnimatePresence>
        {showScroll && (
          <motion.button
            ...
            onMouseLeave={e => {
              e.currentTarget.style.background = 'rgba(11,27,43,0.9)'
      ...
      <motion.a
        ...
        onMouseLeave={e => {
          e.currentTarget.style.background = 'rgba(11,27,43,0.92)'
          e.currentTarget.style.borderColor = 'rgba(244,162,97,0.3)'
